...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="BtnDelete" runat="server" style="z-index: 1; left: 223px; top: 477px; position: absolute; width: 50px;" Text="Delete" Height="33px" OnClick="BtnDelete_Click" />
        ...
        <p>
            <asp:Button ID="BtnEdit" runat="server" style="z-index: 1; left: 150px; top: 478px; position: absolute; right: 1361px;" Text="Edit" Height="33px" Width="38px" OnClick="BtnEdit_Click" />
        </p>
        <asp:Button ID="BtnAdd" runat="server" style="z-index: 1; left: 72px; top: 479px; position: absolute; right: 767px; width: 38px;" Text="Add" Height="33px" OnClick="BtnAdd_Click" Width="38px" />
