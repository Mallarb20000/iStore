...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListBox ID="lstOrderList" runat="server" style="z-index: 1; left: 11px; top: 15px; position: absolute; height: 303px; width: 420px" OnSelectedIndexChanged="lstOrderList_SelectedIndexChanged"></asp:ListBox>
