...
//            if (aCustomer.Timestamp != Convert.ToDateTime("12/10/2023"))
//            {
//                OK = false;
//            }
//            //test to see that the result is correct
...
//            Found = aCustomer.Find(CustomerId);
//            //check the timestamp property
//            if (aCustomer.CustomerEmail != "Hasibeegencc")
//            {
//                OK = false;
//            }
//            //test to see that the result is correct
...
//            Found = aCustomer.Find(CustomerId);
//            //check the timestamp property
//            if (aCustomer.CustomerPostCode != "LE1 1ST")
//            {
//                OK = false;
//            }
//            //test to see that the result is correct
...
//        }
//        [TestMethod]
//        public void TestMembershipActiveFound()
//        { //create an instance of the class we want to create
//            clsCms aCustomer = new clsCms();
//            //create a Boolean variable to store the result of the search
//            Boolean Found = false;
...
//            Found = aCustomer.Find(CustomerId);
//            //check the timestamp property
//            if (aCustomer.Membership != "LE1 1ST")
//            {
//                OK = false;
//            }
//            //test to see that the result is correct
